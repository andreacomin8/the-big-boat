...
class Quiz:
    ...
    def display_question(self):
        ...
        question_label = Label(gui_quiz_base, text=text, font=('ariel', 18, 'bold'), anchor='w', wraplength=680, justify=LEFT, borderwidth=3)
    ...
    def buttons(self):
        ...
        next_button = Button(gui_quiz_base, image = img_conferma , command = self.next_btn,bd=0, highlightthickness=0, borderwidth=0, height=58)
        next_button.place(relx= 0.5, y=620,anchor=S)
        gui_quiz_base.bind('<Return>',self.next_btn)
        quit_button = Button(gui_quiz_base, text="Torna al Menu", command=self.quit_button_function, font=("ariel", 10, " bold"), image=img_back, compound="top")
...
### scrittura risultati nel Frame
        ...
        Label(second_frame,text="Risultati!", fg='white',bg='blue',width=60, height=0, font=('ariel', 16, 'bold'), anchor=CENTER, wraplength=700).pack(fill='x')
        Label(second_frame,text='\nRisposte corrette per ciascuna categoria:\n', width=60, height=0, font=('ariel', 12, 'bold'), anchor='w', wraplength=700).pack(fill=BOTH)

        Label(second_frame,text=text_finale, width=60, height=0, font=('ariel', 12, 'bold'), anchor='w', wraplength=700, justify=LEFT, borderwidth=3).pack(fill=BOTH)
        Label(second_frame,text='\nQuesiti Sbagliati\n', width=60, height=0, font=('ariel', 12, 'bold'),anchor=CENTER, wraplength=700, justify=LEFT, borderwidth=3).pack(fill=BOTH)
        ...
        for i in range(len(self.risposte_sbagliate)):
            ...
            Label(second_frame,text= str(i+1) + " - " + question[self.risposte_sbagliate[i]], font=('ariel', 12, 'bold'), anchor='w', wraplength=700, justify=LEFT, borderwidth=3).pack(fill=BOTH)
            Label(second_frame,text="Risposta corretta: " + risposta_corretta,fg='green', font=('ariel', 12), anchor='w', wraplength=700, justify=LEFT, borderwidth=3).pack(fill=BOTH)
            Label(second_frame,text="Risposta data: " + risposta_data, fg='red', font=('ariel', 12), anchor='w', wraplength=700, justify=LEFT, borderwidth=3).pack(fill=BOTH,pady=(0,10))
