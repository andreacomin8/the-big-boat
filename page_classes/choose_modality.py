...
class ChooseModalityPageBase(GuiPage):
    ...
    def fill_page(self):
        ...
        fac_simile_button = Button(canvas_3,
                                   command=(lambda: page_launcher.pages_transition(self.tk_object, "quiz_esame_base")),
...
class ChooseModalityPageVela(GuiPage):
    def __init__(self, tk_object, width, height, title, background, header_path):
        super().__init__(tk_object, width, height, title, background)
        self.header_path = header_path
        self.fill_page()
    ...
    def fill_page(self):
        ...
        def pers_button_command_vela():
            page_launcher.pages_transition(self.tk_object, "setup_topic_modality_vela")

        global img_pers_button
        img_pers_button = PhotoImage(file='Images/Images_modalità/topic_1.png')
        pers_button = Button(canvas_1, command=pers_button_command_vela,
                             relief=RAISED,
                             image=img_pers_button,
                             height=img_pers_button.height(),
                             width=img_pers_button.width())
        ...
        def ricerca_button_command_vela():
            page_launcher.pages_transition(self.tk_object, "setup_search_modality_vela")

        global ricerca_button_img
        ricerca_button_img = PhotoImage(file='Images/Images_modalità/lente_1.png')
        ricerca_button = Button(canvas_2, command=ricerca_button_command_vela,
                                image=ricerca_button_img,
                                relief=RAISED,
                                height=ricerca_button_img.height(),
                                width=ricerca_button_img.width())
        ...
        fac_simile_button_img = PhotoImage(file='Images/Images_modalità/exam_1.png')
        fac_simile_button = Button(canvas_3,
                                   command=(lambda: page_launcher.pages_transition(self.tk_object, "quiz_esame_vela")),
                                   image=fac_simile_button_img,
                                   relief=RAISED,
                                   height=fac_simile_button_img.height(),
                                   width=fac_simile_button_img.width())
        ...
        def sbagliati_button_command():
            page_launcher.pages_transition(self.tk_object, "setup_error_modality_vela")
